/******/ (function (modules) {
  ...
  /******/ [
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      var _hazeCooking = __webpack_require__(11);

      var _hazeCooking2 = _interopRequireDefault(_hazeCooking);
      ...
      var textures = [
        {
          file: "img/cooking/cooking.jpg",
          name: "image",
          align: textureAlign,
          scale: { x: 1, y: 1 },
        },
        {
          file: "img/cooking/cooking-blur.jpg",
          name: "blur",
          align: textureAlign,
          scale: { x: 0.8, y: 0.8 },
        },
        {
          file: "img/cooking/cooking-maps.jpg",
          name: "maps",
          align: textureAlign,
          scale: { x: 0.05, y: 0.05 },
        },
        {
          file: "img/cooking/noise.png",
          name: "noise",
          repeat: true,
          fill: false,
        },
      ...
      exports.default = function (width, height) {
        ...
        var object = {
          ...
          clearRect: function clearRect(x, y, w, h) {
            ...
            (_ctx = this.ctx).clearRect.apply(
              _ctx,
              _toConsumableArray(d(x, y, w, h))
            );
            return this;
          },
          ...
          quadraticCurveTo: function quadraticCurveTo(cpx, cpy, x, y) {
            ...
            (_ctx5 = this.ctx).quadraticCurveTo.apply(
              _ctx5,
              _toConsumableArray(d(cpx, cpy, x, y))
            );
            return this;
          },
          bezierCurveTo: function bezierCurveTo(cp1x, cp1y, cp2x, cp2y, x, y) {
            ...
            (_ctx6 = this.ctx).bezierCurveTo.apply(
              _ctx6,
              _toConsumableArray(d(cp1x, cp1y, cp2x, cp2y, x, y))
            );
            return this;
          },
          arc: function arc(x, y, r, sAngle, eAngle) {
            ...
            (_ctx7 = this.ctx).arc.apply(
              _ctx7,
              _toConsumableArray(d(x, y, r, sAngle, eAngle, counterclockwise))
            );
            return this;
          },
    ...
    /***/ function (module, exports, __webpack_require__) {
      ...
      GL.prototype = {
        ...
        createUniform: function createUniform(type, name) {
          ...
          WebGL.createUniform.apply(
            WebGL,
            [this.gl, this.program, type, name].concat(v)
          );
        },
        ...
        (function () {
          ...
          function runInContext(context) {
            ...
            var Buffer = moduleExports ? context.Buffer : undefined,
              ...
              iteratorSymbol =
                typeof (iteratorSymbol = Symbol && Symbol.iterator) == "symbol"
                  ? iteratorSymbol
                  : undefined,
            ...
            function mapDelete(key) {
              ...
              if (isKeyable(key)) {
                return hashDelete(
                  typeof key == "string" ? data.string : data.hash,
                  key
                );
              }
            ...
            function baseUnset(object, path) {
              ...
              return (
                !(object != null && baseHas(object, key)) || delete object[key]
              );
            }
            ...
            function isFlattenableIteratee(value) {
              return (
                isArray(value) && !(value.length == 2 && !isFunction(value[0]))
              );
            }
            ...
            function isDate(value) {
              return (
                isObjectLike(value) && objectToString.call(value) == dateTag
              );
            }
